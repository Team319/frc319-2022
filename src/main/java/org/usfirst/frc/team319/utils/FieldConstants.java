...
import org.usfirst.frc.team319.utils.Util.Geometry.Direction;
  ...
  public static final Pose2d cargoG =
      Util.Geometry.offsetDrivetrainFromPose(
          terminalCenter.transformBy(
              new Transform2d(
                  new Translation2d(terminalCargoOffset, 0), Rotation2d.fromDegrees(180))), // was new Translation2d(terminalCargoOffset, 0), Rotation2d.fromDegrees(180)))
          Direction.NEGATIVE,
