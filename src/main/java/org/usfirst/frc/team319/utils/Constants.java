...
public final class Constants {
    ...
    public static final class DriveConstants {
      ...
      public static final double gearRatio = 65 / 9; // 60.0 / 10.0;
      ...
      private static final double bumperlessRobotLength = Units.inchesToMeters(28.5);
      private static final double bumperlessRobotWidth = Units.inchesToMeters(31);
  ...
  */
    public static final class AutoConstants {
      ...
      // WITH WEIGHT
      public static final double ksVolts = 0.15161;//0.68663 ;
      public static final double kvVoltSecondsPerMeter = 3.25;//1.5783; 
      public static final double kaVoltSecondsSquaredPerMeter = 0.1;//0.30354;
  
      public static final double kPDriveVel = 0.0006;//1.5159; //2.5164E-29; //0.00063291;//0.00063291; 
  
      // more kinematics stuff
      public static final double trackWidth = Units.inchesToMeters(24.268);
      public static final DifferentialDriveKinematics kinematics =
          new DifferentialDriveKinematics(trackWidth);
  
      public static final double maxCentripetalAcceleration = 1.54; // was 2.54
      ...
      public static final double maxAccel = Units.feetToMeters(8);
