...
import org.usfirst.frc.team319.robot.commands.climber.SetClimberTelescopePosition;
...
public class ClimbMode extends SequentialCommandGroup {
  ...
  public ClimbMode() {
    ...
    addCommands(new SetRobotMode(RobotMode.Climb), new SetClimberTelescopePosition(0));
  }
}
