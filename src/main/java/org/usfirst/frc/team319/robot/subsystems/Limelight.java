...
public class Limelight extends SubsystemBase {
   ...
   public double getDistance() {
      double angle = this.ty.getDouble(0.0);

      // 70 = height of target - height of cam (96 - 26)   HEY 96 isn't right for on FRC field - EKM
      double distance = 66 / Math.tan( (35+angle) * (Math.PI / 180) );
   ...
   public double getAngleDegrees(){
      return (fovX/2) * getXProportional();
   }
